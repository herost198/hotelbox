...
demo = {
    ...
    showSwal: function(type,option,id) {

        if (type == 'warning-message-and-cancel' && option == 'hotel' ) {
            let host = window.location.origin;
            swal({
                title: "Bạn có chắc chắn xóa Khách sạn?",
                type: "warning",
                showCancelButton: true,
                    ...
                    $.ajax({
                        ...
                        .done(function(data){
                            if(data == 1){
                                ...
                                swal("Xóa Không thành công1!", "", "error");
                            }
                        })
                        .fail(function(){
        ...
        if (type == 'warning-message-and-cancel' && option == 'resetPassword' ) {
            let host = window.location.origin;
            swal({
                title: "Bạn có chắc chắn làm mới mật khẩu?",
                type: "warning",
                showCancelButton: true,
                confirmButtonText: "Có",
                cancelButtonText: "Không",
                    ...
                    $.ajax({
                        ...
                        .done(function(data){
                            if(data == 1){
                                ...
                                swal("Thay đổi mật khẩu không thành công", "", "error");
                            }
                        })
                        .fail(function(){
                            swal("Thay đổi mật khẩu không thành công", "", "error");
        ...
        if (type == 'warning-message-and-cancel' && option == 'boxtv' ) {
            let host = window.location.origin;
            swal({
                title: "Bạn có chắc chắn muốn xóa Box",
                type: "warning",
                showCancelButton: true,
                confirmButtonText: "Có",
                cancelButtonText: "Không",
                ...
                if (isConfirm) {
                    $.ajax({
                        url:host+'/box/delete/'+id,
                        type: "get",
                        error: function(){
                            swal("Xóa Box không thành công", "", "error");
                        }
                    })
                        .done(function(data){
                            if(data == 1){
                                swal("Xóa Box thành công!", "", "success");
                                location.reload();
                            }else{
                                swal("Xóa Box không thành công", "", "error");
                            }
