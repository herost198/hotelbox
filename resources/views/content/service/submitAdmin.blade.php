    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form id="TypeValidation" class="form-horizontal" action="{{url('/service/create')}}" method="POST"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <textarea name="link" id="txtarea1" cols="50" rows="10" class="form-control1 mytinymce"></textarea>
                                    </div>
                                </div>
