    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form id="TypeValidation" class="form-horizontal" action="{{url('/box/edit/'.$box->id)}}" method="POST">
                    {{ csrf_field() }}
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input id='tittle' class="form-control valid" type="text" name="mac" value="{{$box->mac}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-2"  style="margin-top: 6px">
                                    <div class="form-group">
                                        <select name="is_active">
                                            <?php
                                               if($box->is_active == 1){
                                                   echo    '<option value="1" selected > Có</option> <option value="0"> Không</option> ';

                                               }else{
                                                echo    '<option value="1"> Có</option> <option value="0" selected > Không</option>';
