    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-9">
                ...
                ?>
                    <a href="{{url('/notification/'.$result)}}">
                        <button type="" class="btn btn-info">
                            Trở về
                        </button>
                    </a>
                <form id="TypeValidation" class="form-horizontal" action="{{url('/notification/'.$result.'/edit/')}}" method="POST"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <label class="col-sm-2 col-form-label">Tiêu đề
